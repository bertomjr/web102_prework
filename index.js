...
let unfundedGamesString = `
  <div class="unfunded-header">
    <h2>Unfunded Games</h2>
    <p>${
      unfundedGames.length === 1
        ? "There is 1 unfunded game."
        : `There are ${unfundedGames.length} unfunded game(s).`
    }</p>
...
unfundedGamesString += `</div>`;
// create a new DOM element containing the template string and append it to the description container
const unfundedGamesElement = document.createElement("div");
unfundedGamesElement.classList.add("unfunded-section");
